...
<body>
	...
	<div class="main">
		<div class="row">
			...
			<div class="col-xl-10 col-lg-10 col-md-9 main-screen">
				<!-- Page heading -->
				<h3 class="sect-header">Add Gamer</h3>
				<!-- Page navigation -->
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/UserController?action=Dashboard">Home</a></li>
						<li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/GamerController">Gamers</a></li>
						<li class="breadcrumb-item active" aria-current="page">Add Gamer</li>
					</ol>
				</nav>
				...
				<div class="admin-form">
					<form action="${pageContext.request.contextPath}/GamerController"
						method="post" class="needs-validation" novalidate>

						<div class="form-row">
							<div class="form-group col-md-6 form-align">
								<label for="fname">First Name</label> 
								<input type="text" class="form-control" id="fname" name="fname" placeholder="Enter first name" value="${gamer.fname}" required>
							</div>
							<div class="form-group col-md-6 form-align">
								<label for="lname">Last Name</label> 
								<input type="text" class="form-control" id="lname" name="lname" placeholder="Enter Last name" value="${gamer.lname}" required>
							</div>
						</div>
						...
						<div class="form-row">
							<div class="form-group col-md-6 form-align">
								...
								<input type="email" class="form-control" id="emailAdd" name="email" placeholder="Enter email" value="${gamer.email}" required>
								<div class="invalid-feedback">Please enter a valid email address</div>
							</div>
							<div class="form-group col-md-6 form-align">
								<label for="dob">Date of Birth</label> <input type="text" class="form-control" id="dob" name="dob" value="${gamer.dob}">
							</div>
						</div>
						...
						<div class="form-row">
							<div class="form-group col-md-6 form-align">
								...
								<input type="text" class="form-control" id="uname" name="uname" placeholder="Enter Username" value="${gamer.username}" required>
							</div>
							<div class="form-group col-md-6 form-align">
						...
						<div class="form-row" id = "passCol" <%= hidden %>>
							<div class="form-group col-md-6 form-align">
								<label for="pass">Password</label> 
								<input type="password" class="form-control" id="newpass" name="pass" placeholder="Enter password" > 
							...
							<div class="form-group col-md-6 form-align">
								...
								<input type="password" class="form-control" id="repass" name="repass" placeholder="Re-Enter password" >
	...
	<script>
		...
		var subcat = document.getElementById('admin-cus');
		subcat.classList.add("show");
		var sublink = document.getElementById('add-cus');
		sublink.classList.add("active");

		//Displays the gamers country in select option
		var country = '${gamer.country}';
		if(country !== ""){
