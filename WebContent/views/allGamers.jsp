  ...
  <div class="main">
    <div class="row">
      ...
      <div class="col-xl-10 col-lg-10 col-md-9 main-screen">
        <!-- Page heading -->
        <h3 class="sect-header">All Gamers</h3>
        <!-- Page navigation -->
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">All Gamers</li>
          </ol>
        </nav>
            ...
            <table id="example" class="table table-striped table-bordered table-responsive-lg" style="width:100%">
                ...
                <c:forEach items = "${list}" var = "cus">
                    <tr>
                        ...
                        <td>${cus.dob}</td>
                        <td>${cus.country}</td>
                        <td> <a href="${pageContext.request.contextPath}/GamerController?action=EDIT&id=${cus.id}">Edit</a>  |  <button class="del" onClick ="deleteUser(${cus.id});"> Delete</button></td>
                    </tr> 
                 </c:forEach>
                </tbody>
...
var sublink = document.getElementById('all-cus');
...
function deleteUser(id){
	if(confirm("Are you sure you want to delete ?"))
		{
			window.location.href = "<%=request.getContextPath()%>/GamerController?action=DELETE&id="+id;
		}
}
...
if (action == null && id == null ){
	window.location.href = "<%=request.getContextPath()%>/GamerController?action=success"; /* This redirects the link back to the server only once and displays the table to prevent adding multiple records to the db on reloading the page */
}
