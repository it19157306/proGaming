...
<jsp:include page="Header.jsp"></jsp:include>
  <div class="register">
      <div class="register-form">
            ...
            <div class = "col-md-8 register-form-content" >
            <div class="">
                <h1 class = "register-form-head">REGISTER</h1>     

                <form action = "${pageContext.request.contextPath}/GamerController?action=home" method = "post" class="needs-validation" novalidate>
                    ...
                    <div class="form-row">
                      <div class="form-group col-md-6 form-align">
                        <input type="password" class="form-control" id="newpass" name="pass" placeholder="Password" required>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12 btn-submit-col">
                        ...
                        <a class="btn btn-submit">Cancel</a>
